...
import { useIsMobile } from "@viral-scout/ui/hooks/use-mobile"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@viral-scout/ui/components/sheet"
import { Skeleton } from "@viral-scout/ui/components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@viral-scout/ui/components/tooltip"
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-3 overflow-hidden rounded-lg p-2.5 text-left text-sm outline-hidden transition-all group-has-data-[sidebar=menu-action]/menu-item:pr-10 group-data-[collapsible=icon]:size-10! group-data-[collapsible=icon]:p-2.5! hover:bg-primary/5 hover:text-primary disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-primary/5 data-open:hover:text-primary data-active:bg-primary/10 data-active:text-primary [&_svg]:size-5 [&_svg]:shrink-0 [&_svg]:transition-colors hover:[&_svg]:text-primary data-active:[&_svg]:text-primary [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
        default: "hover:bg-primary/5 hover:text-primary",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-primary/5 hover:text-primary hover:shadow-[0_0_0_1px_rgba(59,130,246,0.2)]"
      },
      size: {
